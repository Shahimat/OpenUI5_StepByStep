...
Имя файла для **Controller** всегда выглядит так - `<имя>.controller.js`. Желательно все **Controller** хранить в папке с именем **controller** (тема предпочитаемой файловой структуры будет раскрыта далее).
